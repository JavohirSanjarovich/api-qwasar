...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { age: @dog.age, gender: @dog.gender, name: @dog.name, sound: @dog.sound } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { age: @dog.age, gender: @dog.gender, name: @dog.name, sound: @dog.sound } }, as: :json
    assert_response :success
  end
